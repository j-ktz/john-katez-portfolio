...
(function(){
  ...
  function initCreativeGallery(){
    ...
    const state = { filter:"all", q:"" , videos:[], links:[]};
    ...
    function render(){
      ...
      const passFilter = (obj) => {
        ...
        if (state.filter === "video") return obj.__kind === "video";
        if (state.filter === "social") return obj.__kind === "social";
        if (state.filter === "award") return obj.type === "award";
        if (state.filter === "press") return obj.type === "press";
        return true;
      };
